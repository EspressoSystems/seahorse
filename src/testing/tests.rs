...
pub mod generic_keystore_tests {
    ...
    pub async fn test_keystore_freeze<'a, T: SystemUnderTest<'a>>() -> std::io::Result<()> {
        ...
        let expected_history = vec![
            transactions::create_test_txn( TransactionParams {
                uid: Some(r1.uid),
                timeout: None,
            ...
            transactions::create_test_txn( TransactionParams {
                uid: Some(xfr_receipt.uid.clone()),
                timeout: None,
                status: TransactionStatus::Unknown,
                memos: Default::default(),
                sig: None,
    ...
    pub async fn test_txn_history<'a, T: SystemUnderTest<'a>>() {
        ...
        let expected_entry = TxnHistoryWithTimeTolerantEq( transactions::create_test_txn( TransactionParams {
            uid: Some(receipt.uid.clone()),
            timeout: None,
            status: TransactionStatus::Unknown,
            memos: Default::default(),
