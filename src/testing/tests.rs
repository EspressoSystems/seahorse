...
pub mod generic_keystore_tests {
                ...
                let mut amount = if U256::from(*amount) <= sender_balance {
                    *amount
                    ...
                    push_history(
                        ...
                        &mut histories,
                        Transaction {
                            uid: TransactionUID(random_txn_hash(&mut ChaChaRng::from_seed([0x42u8; 32]))),
                            timeout: None,
                            hash: None,
                            status: TransactionStatus::Unknown,
                            pending_uids: HashSet::new(),
    ...
    pub async fn test_txn_history<'a, T: SystemUnderTest<'a>>() {
        ...
        let expected_entry = TxnHistoryWithTimeTolerantEq(Transaction {
