    ...
    > Keystore<'a, Backend, L, Meta>
{
    ...
    /// have viewable records. The keystore will start a scan of the ledger in the background to
    /// find records viewable by this key. The scan will start from the event specified by
    /// `scan_from`.
    ...
    ///
    /// Since this key was not generated by this keystore, it may have already been used and thus may
    /// have freezable records. The keystore will start a scan of the ledger in the background to
    /// find records freezable by this key. The scan will start from the event specified by
    /// `scan_from`.
